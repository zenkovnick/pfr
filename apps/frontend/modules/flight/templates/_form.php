...
<ul class="flight-field-list">
    ...
    <li style="display: none;" class="small-field right"><?php include_partial("flight/time_field", array('field' => $form['departure_time'], 'placeholder' => 'HHMM', 'label' => false)); ?></li>
    <li class="small-field right"><?php include_partial("flight/field", array('field' => $form['time_str'], 'placeholder' => 'HHMM', 'class'=>'time', 'label' => false)); ?></li>
