                            ...
                            <tr>
                                <td style="border-bottom: 1px dashed #CCC; padding: 10px 0;">
                                    <div style="float: left; max-width: 75%;">
                                        <p style="color: #000 !important; margin: 0;" class="question"><?php echo $risk_factor['question'] ?></p>
                                        <span style="color: #CCC;" class="answer"><?php echo $risk_factor['answer'] ?></span>
                                    </div>
                                    <div style="background: #F33; border: 1px solid #F00; float: right; padding: 10px 0; text-align: center; width: 40px;" class="risk">
                                        <span style="color: #FFF;"><?php echo $risk_factor['risk'] ?></span>
                                    </div>
