...
<form class="sign-in-form" action="<?php echo url_for('@signin_process') ?>" method="post">
    <fieldset class="blog-login">
        ...
        <ul>
            <li class="text">
                <?php include_partial("registration/field", array('field' => $form['username'], 'placeholder' => 'Email', 'label' => false)); ?>
            </li>

            <li class="text">
                <?php include_partial("registration/field", array('field' => $form['password'], 'placeholder' => 'Password', 'label' => false)); ?>
            </li>
        </ul>
