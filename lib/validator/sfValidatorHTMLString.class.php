 ...
 */
class sfValidatorHTMLString extends sfValidatorBase
{
    /**
    ...
    {
        $clean = (string) $value;
        $clean_without_tags = strip_tags($clean);
        $length = function_exists('mb_strlen') ? mb_strlen($clean_without_tags, $this->getCharset()) : strlen($clean_without_tags);
