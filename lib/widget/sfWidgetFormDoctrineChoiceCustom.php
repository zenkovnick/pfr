...
class sfWidgetFormDoctrineChoiceCustom extends sfWidgetFormChoice
{
    /**
     * @see sfWidget
     */
    ...
    protected function configure($options = array(), $attributes = array())
    {
        ...
        $this->addOption('method_parameters', null);
        $this->addOption('table_method_parameters', null);
    ...
    public function getChoices()
    {
        ...
        else
        {
            ...
            $results = Doctrine_Core::getTable($this->getOption('model'))->$tableMethod($this->getOption('table_method_parameters'));
        ...
        {
            $choices[$object->$keyMethod()] = $object->$method($this->getOption('method_parameters'));
        }
