...
abstract class BaseRiskBuilderFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'mitigation_low_email'              => new sfWidgetFormFilterInput(),
      ...
      'mitigation_medium_email'           => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'mitigation_low_email'              => new sfValidatorPass(array('required' => false)),
      ...
      'mitigation_medium_email'           => new sfValidatorPass(array('required' => false)),
