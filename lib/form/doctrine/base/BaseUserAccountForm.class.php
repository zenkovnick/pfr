...
abstract class BaseUserAccountForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'is_pic'       => new sfWidgetFormInputCheckbox(),
      'is_sic'       => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'is_pic'       => new sfValidatorBoolean(array('required' => false)),
      'is_sic'       => new sfValidatorBoolean(array('required' => false)),
