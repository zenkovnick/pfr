...
abstract class BaseRiskBuilderForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'mitigation_low_email'              => new sfWidgetFormInputText(),
      ...
      'mitigation_medium_email'           => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'mitigation_low_email'              => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      ...
      'mitigation_medium_email'           => new sfValidatorString(array('max_length' => 255, 'required' => false)),
