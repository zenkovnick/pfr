...
/**
 * RiskFactorField form base class.
 *
 * @method RiskFactorField getObject() Returns the current form's model object
 *
 * @package    blueprint
 * @subpackage form
 ...
 */
abstract class BaseRiskFactorFieldForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'help_mewssage'   => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'help_mewssage'   => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'position'        => new sfValidatorInteger(array('required' => false)),
      'created_at'      => new sfValidatorDateTime(),
      'updated_at'      => new sfValidatorDateTime(),
    ));

    $this->widgetSchema->setNameFormat('risk_factor_field[%s]');
